...
function Item({ heading, desc, button, imgUrl, href, whiteText = false }) {
    return (
        <div className={cx('item')}>
            <div className={cx('item-img-cover')} style={{ backgroundImage: `url(${imgUrl})` }}></div>
            <div className={cx('item-content')}>
                <div className={cx('content-wrapper', { whiteText })}>
                    <div className={cx('heading')}>
                        <h2>
                            <Link className={cx('heading-title', { whiteText })} to={href}>
                                {heading}
                            </Link>
                        </h2>
